                ...
                <div>
                    ...
                    <FormItem
                        ...
                        <Row :gutter="10">
                            ...
                            <Col span="3">
                                <Button :disabled="!index && form.items.length==1" @click="handleRemove(index)">删除
                                </Button>
                            </Col>
                        </Row>
                    </FormItem>
        ...
        data() {
            return {
                urls: {
                    ...
                    upload: '//dixfe.oss-cn-shanghai.hongkong.com/',   //上传地址
        ...
        methods: {
            ...
            handleSubmit() {
                ...
                this.$refs.form.validate((valid) => {
                    if (valid) {
                        this.$admin.putProduct(this.form).then(function (res) {
                            if (res.code === 200) {
                                that.$Notice.success({
                                    title: res.msg
                                });
