...
}],attrs:{"value":_vm.value},on:{"click":function($event){$event.stopPropagation();_vm.selectOptionClick($event)},"mouseleave":_vm.leaveItem,"mouseenter":_vm.hoverItem}},[_vm._v("\n    "+_vm._s(_vm.label)+"\n")])}
